...
def load_and_plot_rq1_results(csv_file='av_rq1_scalability_results.csv',adf=None):
    """Load AV RQ1 results from CSV and create plot."""
    ...
    if adf is None:
        ...
        try:
            ...
            print(f"✗ File {csv_file} not found. Run av_rq1_generate_data.py first to generate data.")
            return
    ...
    if adf is None:
        ...
        print(f"✓ Plot saved as: av_rq1_scalability_plot.png")    
        plt.close(fig)
    else:
        plt.show()
    ...
    print(f"✓ Plot data saved to: av_rq1_plot_data.csv")

def main():
    """Main function to create plots from saved data."""
    print("=" * 60)
    print("AV RQ1 RESULTS PLOTTER")
    print("=" * 60)
